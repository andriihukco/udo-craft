...
interface CustomizerCanvasProps {
  ...
  onLayerTextChange?: (id: string, newText: string) => void;
  onAIGenerate?: () => void;
}
...
export function CustomizerCanvas({
  ...
  onRemoveBg, onRemoveBgStateChange, onLayerDelete, onLayerDuplicate, onLayerTransformChange, onLayerTextChange, onAIGenerate,
