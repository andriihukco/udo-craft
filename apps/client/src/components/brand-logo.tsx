    ...
    return (
      <div className={cn("flex items-center justify-center", className)}>
        <svg width="20" height="24" viewBox="0 0 20 24" fill="none" aria-hidden="true">
          <path
            d="M0 0H8.72727V109.091H109.091V0H196.364V141.818C196.364 204.545 152.406 240 98.1818 240C43.9575 240 0 201.818 0 141.818V0Z"
            fill={color}
          />
        </svg>
      </div>
  ...
  return (
    <div className={cn("flex items-center", className)}>
      <svg
        ...
        role="img"
      >
        <path d="M0 0H8.72727V10.9091H10.9091V0H19.6364V141.818C19.6364 204.545 15.2406 240 98.1818 240C43.9575 240 0 201.818 0 141.818V0Z" fill={color} />
