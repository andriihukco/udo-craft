...
interface PricingRow {
  ...
  size_min_cm: number; size_max_cm: number; qty_tiers: QtyTier[];
}

function calcPrice(tiers: QtyTier[], qty: number): number | null {
                  ...
                  <div className="flex items-center gap-0 p-2">
                    ...
                    <div className="flex-1 min-w-0 px-2">
                      ...
                      <div className="flex items-center gap-1 mt-0.5">
                        ...
                        <span className="text-[10px] text-muted-foreground/60">{layer.side}</span>
                      </div>
                    </div>
                            ...
                            <div className="flex gap-1">
                              {(["left","center","right"] as const).map((a) => (
                                <button key={a} type="button" onClick={() => onTextChange(layer.id, { textAlign: a })}
                                  title={a === "left" ? "Ліво" : a === "center" ? "Центр" : "Право"}
